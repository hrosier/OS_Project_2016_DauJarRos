...
SRCS := catapult.c catapultTest.c colorTest.c grab.c grabTest.c init.c mainTest.c movement.c movementTest.c sonar.c sonarTest.c tester.c turn.c turnTest.c position.c
